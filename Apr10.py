...
__all__ = ['extract_user_item_browse_feature',
           'extract_user_item_browse_feature_with_label']
...
def extract_user_item_browse_feature(df, date, days=3, detail_days=1):
    """
...
def extract_user_item_browse_feature_with_label(df, date, days=3, detail_days=1):
    """
    ...
    training_data = extract_user_item_browse_feature(df, last_day, days, detail_days)
    # labeled
...
if __name__ == '__main__':
    ...
    # 训练数据
    extract_user_item_browse_feature_with_label(u, '2014-12-18').to_csv('data/train/apr10_2014-12-18.csv')
    # 测试数据
    extract_user_item_browse_feature_with_label(u, '2014-12-17').to_csv('data/train/apr10_2014-12-17.csv')
    # 预览数据
    extract_user_item_browse_feature(u, '2014-12-18').to_csv('data/train/predict_2014-12-18.csv')